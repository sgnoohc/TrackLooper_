...
{
    ana.histograms.addVecHistogram(TString::Format("Segment_dz"),4000,-200,200,[&](){return dzValues;});
    ...
    ana.histograms.addVecHistogram(TString::Format("Segment_barrel_dz"),4000,-200,200,[&](){return barreldzValues;});
    ...
    ana.histograms.addVecHistogram(TString::Format("Segment_endcap_drt"),2000,0,200,[&](){return endcapdrtValues;});
    ...
    {
        ana.histograms.addVecHistogram(TString::Format("Segment_dz_layer_%ld",i+1),4000,-200,200,[&,i](){return layerdzValues[i];});
        ...
        ana.histograms.addVecHistogram(TString::Format("Segment_barrel_dz_layer_%ld",i+1),4000,-200,200,[&,i](){return layerBarreldzValues[i];});
        ...
        if(i < 5)
        {
            ana.histograms.addVecHistogram(TString::Format("Segment_endcap_drt_layer_%ld",i+1),2000,0,200,[&,i](){return layerEndcapdrtValues[i];});
    ...
    {
        ana.histograms.addVecHistogram(TString::Format("Segment_endcap_drt_ring_%ld",i+1),2000,0,200,[&,i](){return ringEndcapdrtValues[i];});

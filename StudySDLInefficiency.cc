...
void StudySDLInefficiency::doStudy(SDL::Event& event, std::vector<std::tuple<unsigned int, SDL::Event*>> simtrkevents)
{
    ...
    for (auto& simtrkevent : simtrkevents)
    {
        ...
        ana.tx->setBranch<int>("is_trk_bbbbbb", hasAll12HitsInBarrel(isimtrk));
        ana.tx->setBranch<int>("is_trk_bbbbbe", hasAll12HitsWithNBarrel(isimtrk, 5));
        ana.tx->setBranch<int>("is_trk_bbbbee", hasAll12HitsWithNBarrel(isimtrk, 4));
        ana.tx->setBranch<int>("is_trk_bbbeee", hasAll12HitsWithNBarrel(isimtrk, 3));
        ana.tx->setBranch<int>("is_trk_bbeeee", hasAll12HitsWithNBarrel(isimtrk, 2));
        ana.tx->setBranch<int>("is_trk_beeeee", hasAll12HitsWithNBarrel(isimtrk, 1));

...
mdf = open("temp.md","w")
mdf.write("% Hit Occupancy summary\n")
...
os.system("~/local/bin/pandoc temp.md -f markdown -t html -s -o {}/{}.html".format("~/public_html/SDL/SDL_Occupancies_20200407/summaries/","hit_summary"))

...
//********************************************************************************
    ...
    // Read the options
    options.add_options()
        ("m,mode"           , "Run mode (0=build_module_map, 1=mtv, 2=algo_eff, 3=tracklet)"                                        , cxxopts::value<int>()->default_value("-1"))
    ...
    switch (ana.mode)
    {
        ...
        case 1: mtv(); break;
        case 2: algo_eff(); break;
        case 3: tracklet(); break;
        default:
                std::cout << options.help() << std::endl;
                std::cout << "Warning: --mode was not recognized... Doing nothing..." << std::endl;
                break;
    }

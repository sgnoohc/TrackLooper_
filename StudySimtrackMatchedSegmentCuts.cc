...
{
    ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_dzDiffLow"),1000,0,100,[&](){return dzDiffLowValues;});
    ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_dzDiffHigh"),1000,0,100,[&](){return dzDiffHighValues;});
    ...
    ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_dzDiffLow"),1000,0,100,[&](){return barreldzDiffLowValues;});
    ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_dzDiffHigh"),1000,0,100,[&](){return barreldzDiffHighValues;});
    ...
    ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_endcap_drtDiffLow"),1000,0,100,[&](){return endcapdrtDiffLowValues;});
    ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_endcap_drtDiffHigh"),1000,0,100,[&](){return endcapdrtDiffHighValues;});
    ...
    {
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_dzDiffLow_layer_%ld",i+1),1000,0,100,[&,i](){return layerdzDiffLowValues[i];});
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_dzDiffHigh_layer_%ld",i+1),1000,0,100,[&,i](){return layerdzDiffHighValues[i];});
        ...
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_dzDiffLow_layer_%ld",i+1),1000,0,100,[&,i](){return layerBarreldzDiffLowValues[i];});

        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_to_barrel_dzDiffLow_layer_%ld",i+1),1000,0,100,[&,i](){return layerBarrelToBarreldzDiffLowValues[i];});

        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_to_barrel_dzDiffHigh_layer_%ld",i+1),1000,0,100,[&,i](){return layerBarrelToBarreldzDiffHighValues[i];});

        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_to_endcap_dzDiffLow_layer_%ld",i+1),1000,0,100,[&,i](){return layerBarrelToEndcapdzDiffLowValues[i];});
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_to_endcap_dzDiffHigh_layer_%ld",i+1),1000,0,100,[&,i](){return layerBarrelToEndcapdzDiffHighValues[i];});

        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_to_endcap_drtDiffLow_layer_%ld",i+1),1000,0,100,[&,i](){return layerBarrelToEndcapdrtDiffLowValues[i];});
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_to_endcap_drtDiffHigh_layer_%ld",i+1),1000,0,100,[&,i](){return layerBarrelToEndcapdrtDiffHighValues[i];});


        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_dzDiffHigh_layer_%ld",i+1),1000,0,100,[&,i](){return layerBarreldzDiffHighValues[i];});
        ...
        if(i < 5)
        {
            ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_endcap_drtDiffLow_layer_%ld",i+1),1000,0,100,[&,i](){return layerEndcapdrtDiffLowValues[i];});
            ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_dncap_drtDiffHigh_layer_%ld",i+1),1000,0,100,[&,i](){return layerEndcapdrtDiffHighValues[i];});
        ...
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_center_dAlphaOuterMDSegment_layer_%ld",i+1),200,-6.28,6.28,[&,i](){return layerBarrelCenterdAlphaOuterMDSegmentValues[i];});
        ...
        if(i < 3)
        {
            ...
            ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_normal_tilted_dPhiChange_layer_%ld",i+1),200,-6.28,6.28,[&,i](){return layerBarrelNormalTilteddPhiChangeValues[i];});
            ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_normal_tilted_dAlphaInnerMDSegment_layer_%ld",i+1),200,-6.28,6.28,[&,i](){return layerBarrelNormalTilteddAlphaInnerMDSegmentValues[i];});
            ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_normal_tilted_dAlphaOuterMDSegment_layer_%ld",i+1),200,-6.28,6.28,[&,i](){return layerBarrelNormalTilteddAlphaOuterMDSegmentValues[i];});
            ...
            ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_endcap_tilted_dPhiChange_layer_%ld",i+1),200,-6.28,6.28,[&,i](){return layerBarrelEndcapTilteddPhiChangeValues[i];});
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_endcap_tilted_dAlphaInnerMDSegment_layer_%ld",i+1),200,-6.28,6.28,[&,i](){return layerBarrelEndcapTilteddAlphaInnerMDSegmentValues[i];});
            ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_barrel_endcap_tilted_dAlphaOuterMDSegment_layer_%ld",i+1),200,-6.28,6.28,[&,i](){return layerBarrelEndcapTilteddAlphaOuterMDSegmentValues[i];});
    ...
    {
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_endcap_drtDiffLow_ring_%ld",i+1),1000,0,100,[&,i](){return ringEndcapdrtDiffLowValues[i];});
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_endcap_drtDiffHigh_ring_%ld",i+1),1000,0,100,[&,i](){return ringEndcapdrtDiffHighValues[i];});
        ...
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_endcap_to_endcap_drtDiffLow_ring_%ld",i+1),1000,0,100,[&,i](){return ringEndcapToEndcapdrtDiffLowValues[i];});
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_endcap_to_endcap_drtDiffHigh_ring_%ld",i+1),1000,0,100,[&,i](){return ringEndcapToEndcapdrtDiffHighValues[i];});

        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_endcap_to_barrel_drtDiffLow_ring_%ld",i+1),1000,0,100,[&,i](){return ringEndcapToBarreldrtDiffLowValues[i];});
        ana.histograms.addVecHistogram(TString::Format("sim_matched_Segment_endcap_to_barrel_drtDiffHigh_ring_%ld",i+1),1000,0,100,[&,i](){return ringEndcapToBarreldrtDiffHighValues[i];});

...
if [ ! -d "${OUTPUTDIR}" ]; then
    ...
    if [[ $DATASET == "0" ]]; then
        ...
        for i in $(seq 0 $((NJOBS-1))); do
            echo "time ./bin/tracklet -i ${PU200SAMPLE} -n -1 -t trackingNtuple/tree -o ${OUTPUTDIR}/${OUTPUTFILEBASENAME}_${i}.root -v 1 -x ${i} > ${OUTPUTDIR}/${OUTPUTFILEBASENAME}_${i}.log 2>&1 " >>  .jobs.txt
        done
    fi
    ...
    if [[ $DATASET == "1" ]]; then
        ...
        NJOBS=1
        for i in $(seq 0 $((NJOBS-1))); do
            echo "time ./bin/tracklet -i ${TRACKINGNTUPLEDIR}/CMSSW_10_4_0/src/trackingNtuple_pt0p95_1p05_10MuGun.root -n -1 -t trackingNtuple/tree -o ${OUTPUTDIR}/${OUTPUTFILEBASENAME}_${i}.root -v 1 > ${OUTPUTDIR}/${OUTPUTFILEBASENAME}_${i}.log  2>&1 " >  .jobs.txt
        done
    fi
    ...
    if [[ $DATASET == "2" ]]; then
        ...
        echo "" > .jobs.txt
        for i in $(seq 0 $((NJOBS-1))); do
            echo "time ./bin/tracklet -j ${NJOBS} -I ${i} -i ${TRACKINGNTUPLEDIR}/CMSSW_10_4_0/src/trackingNtuple_100_pt0p5_2p0.root -n -1 -t trackingNtuple/tree -o ${OUTPUTDIR}/${OUTPUTFILEBASENAME}_${i}.root -v 1 > ${OUTPUTDIR}/${OUTPUTFILEBASENAME}_${i}.log  2>&1 " >>  .jobs.txt
        done
    fi
    ...
    if [[ $DATASET == "3" ]]; then
        ...
        echo "" > .jobs.txt
        for i in $(seq 0 $((NJOBS-1))); do
            echo "time ./bin/tracklet -j ${NJOBS} -I ${i} -i ${TRACKINGNTUPLEDIR}/CMSSW_10_4_0/src/trackingNtuple_100_pt0p5_3p0.root -n -1 -t trackingNtuple/tree -o ${OUTPUTDIR}/${OUTPUTFILEBASENAME}_${i}.root -v 1 > ${OUTPUTDIR}/${OUTPUTFILEBASENAME}_${i}.log  2>&1 " >>  .jobs.txt
        done
    fi
    ...
    if [[ $DATASET == "200" ]]; then
        ...
        echo "" > .jobs.txt
        for i in $(seq 0 $((NJOBS-1))); do
            echo "time ./bin/tracklet -j ${NJOBS} -I ${i} -i ${SAMPLEPATH} -n -1 -t trackingNtuple/tree -o ${OUTPUTDIR}/${OUTPUTFILEBASENAME}_${i}.root -v 1 > ${OUTPUTDIR}/${OUTPUTFILEBASENAME}_${i}.log  2>&1 " >>  .jobs.txt
        done
    fi

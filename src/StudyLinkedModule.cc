...
void StudyLinkedModule::bookStudy()
{
    ...
    for(int i=0;i<15;i++)
    {
        ...
        ana.histograms.addHistogram(TString::Format("average_Linked_Module_number_in_endcap_for_ring_%d",i+1),5000,0,500,[&,i](){return averagenEndcapRingLinkedModules.at(i);});
        ...
        ana.histograms.addVecHistograms(TString::Format("Linked_Module_number_in_endcap_for_ring_%d",i+1),500,0,500,[&,i](){return nRingEndcapLinkedModules.at(i);});
    ...
    for(int i=0; i<15;i++)
    {
        for(int j=0; j<6; j++)
        {
            ...
            ana.histograms.addVecHistogram(TString::Format("Linked_module_occupancy_layer_%d_ring_%d",j+1,i+1),500,0,500,[&,i](){return nEndcapLayerRingLinkedModuleOccupancy[i][j];});
        }
        ...
        ana.histograms.addHistogram(TString::Format("average_number_of_Linked_modules_in_inner_endcap_for_ring_%d",i+1),500,0,500,[&,i](){return averagenInnerRingEndcapLinkedModules[i];});
        ...
        ana.histograms.addHistogram(TString::Format("average_number_of_Linked_modules_in_outer_endcap_for_ring_%d",i+1),500,0,500,[&,i](){return averagenOuterRingEndcapLinkedModules[i];});
...
void StudyLinkedModule::doStudy(SDL::Event &event,std::vector<std::tuple<unsigned int, SDL::Event*>> simtrkevents)
{
    ...
    for(int i=0;i<15;i++)
    {
        ...
        averagenInnerRingEndcapLinkedModules.push_back(0);
        averagenOuterRingEndcapLinkedModules.push_back(0);
    }
    ...
    for(int i = 0; i<6;i++)
    {
        for(int j = 0; j<15; j++)
        {
            ...
            nEndcapLayerRingLinkedModules.push_back[i].push_back(std::vector<float>());
        }
    }
    ...
    for(auto &module:moduleList)
    {
        ...
        if(module->subdet() == SDL::Module::Barrel)
        {
            if((module->getMiniDoubletPtrs()).size() != 0)
            {
                ...
                nLayerBarrelLinkedModules.at(module->layer()-1).push_back(connectedModuleOccupancy);
                averagenLayerBarrelLinkedModules.at(module->layer()-1) += connectedModuleOccupancy;
        ...
        else if(module->subdet() == SDL::Module::Endcap)
        {
            if((module->getMiniDoubletPtrs()).size() != 0)
            {
                ...
                nEndcapLinkedModules.push_back(connectedModuleOccupancy);
                ...
                {
                    averagenInnerRingEndcapLinkedModules.at(module->ring()-1) += nConnectedModules;
                ...
                {
                    averagenOuterRingEndcapLinkedModules.at(module->ring()-1) += nConnectedModules;
    ...
    for(int i=0;i<15;i++)
    {
        ...
        averagenInnerRingEndcapLinkedModules[i] = (nInnerRingEndcapModules.at(i) != 0) ? averagenInnerRingEndcapLinkedModules[i]/nInnerRingEndcapModules[i] : 0;
        averagenOuterRingEndcapLinkedModules[i] = (nOuterRingEndcapModules.at(i) != 0) ? nOuterRingEndcapLinkedModules[i]/averagenOuterRingEndcapModules[i] : 0;
    }
}
